...
export default function ImprovedChat() {
  ...
  const [messages, setMessages] = useState<{ userId: string; userName: string; userImage: string; content: string }[]>([]);
  ...
  const socketInitializer = async () => {
    ...
    socket.on("chat message", (msg: { userId: string; userName: string; userImage: string; content: string }) => {
